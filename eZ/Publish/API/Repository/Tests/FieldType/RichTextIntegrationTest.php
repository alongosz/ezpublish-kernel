...
*/
    ...
    public function testCreateContentWithInvalidCustomTag(
        ...
        $this->expectExceptionMessage($expectedValidationMessage);
        ...
        try {
            ...
            // wrap ValidationError in something throwable
            throw new \RuntimeException($error->getTranslatableMessage()->message);
        }
    }
